...
### 결론
Spread 연산자는 JavaScript에서 데이터를 복사하고 조작하는 도구다.
얕은 복사의 성질을 알고 상황에 맞게 쓴다.
중첩 객체는 참조를 공유하니 깊은 복사를 쓴다.
함수 인자 전달과 배열/객체 조작에서 특히 쓸모가 크다.
Spread 연산자로 불변성을 지키면서 데이터를 안전하게 다룬다.

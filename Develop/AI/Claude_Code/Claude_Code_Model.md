...
아래 표는 4.x 계열 기준이다. 현재 최신은 Claude 5 계열(Opus 5 · Sonnet 5 · Fable 5)이라
실제 청구액은 [Anthropic 요금 페이지](https://www.anthropic.com/pricing)에서 확인해야 한다.
비율 감각(Opus 가 Sonnet 의 5배)은 세대가 바뀌어도 대체로 유지된다.

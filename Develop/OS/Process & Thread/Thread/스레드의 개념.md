...
스레드끼리는 같은 프로세스의 힙, 데이터, 코드 영역을 공유하고, 스택과 레지스터 상태만 각자 가진다. 공유/독립 자원의 상세 구조는 [쓰레드의 자원 구조](쓰레드의%20자원%20구조.md)에서 다룬다.

<div align="center">
    <img src="../../../etc/image/OS/스레드의 구조.webp" alt="스레드의 구조.webp" width="30%">
</div>

...
<section class="yg-hero">
  <div class="yg-hero-inner">
    ...
    <h1 class="yg-hero-title">시스템과 인프라,<br>그 사이의 모든 것</h1>
    <p class="yg-hero-sub">Kang Young Gyu · Backend Engineer<br>Kubernetes와 인프라 자동화를 좋아합니다. 시스템을 안정적으로 운영하는 방법에 대한 기록.</p>
    <div class="yg-hero-tags">
      <span>Java</span><span>Spring Boot</span><span>Node.js</span><span>TypeScript</span>
      <span>AWS</span><span>MySQL</span><span>MongoDB</span><span>Redis</span>

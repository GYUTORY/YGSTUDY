...
<div class="profile">
<p class="profile-name"><strong>Kang Young Gyu</strong> <span class="profile-role">Backend Engineer</span></p>
<p class="profile-bio">I care more about keeping systems running than building them.<br>Lately obsessed with Kubernetes and infrastructure automation.</p>
...
<a href="http://gyutory.co.kr/momo" target="_blank"><img src="assets/images/momo_assistant.png" alt="MOMO Assistant"></a>
...
<div class="item" data-cat="language" markdown>
...
<div class="item" data-cat="framework" markdown>
...
<div class="item" data-cat="arch" markdown>
...
<div class="item" data-cat="backend" markdown>
...
<div class="item" data-cat="database" markdown>
...
<div class="item" data-cat="aws" markdown>
...
<div class="item" data-cat="devops" markdown>

### DevOps

[CI/CD](DevOps/CI_CD/GitHub_Actions.md) · [GitOps](DevOps/GitOps/GitOps_전략.md) · [K8s](DevOps/Kubernetes/Kubernetes.md) · [Docker](DevOps/Kubernetes/Docker/Docker_Compose.md) · [IaC](DevOps/Infrastructure_as_Code/Terraform_기초.md) · [DevSecOps](DevSecOps/Dev_Sec_Ops.md)

</div>

<div class="item" data-cat="linux" markdown>
...
<div class="item" data-cat="webserver" markdown>
...
<div class="item full" data-cat="ai" markdown>
...
<div class="item" data-cat="network" markdown>
...
<div class="item" data-cat="security" markdown>
...
<div class="item" data-cat="os" markdown>

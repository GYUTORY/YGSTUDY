---
title: 장애 대응 — 터졌을 때 무엇을 하고, 사후에 무엇을 남기나
tags: [engineering, microservices, observability, kubernetes, monitoring]
updated: 2026-04-26
---

# 장애 대응
이 문서는 원래 `Architecture/MSA/` 아래 있었다. 그런데 내용을 보면 인시던트 라이프사이클·SLO·온콜·런북·포스트모템은 **아키텍처와 무관한 보편 주제**다. MSA 를 안 쓰는 사람이 영영 못 보는 자리에 있을 이유가 없어 여기로 옮겼다(2026-09-02). 카스케이딩 장애와 서비스 메시 재시도 예산 두 절만 MSA 특화다.

...
### Q1. KMS 키를 분실하면 어떻게 되나요?
A. 키를 분실하거나 삭제하면, 해당 키로 암호화된 데이터는 복구할 수 없습니다. 키 관리에 각별히 주의!

### Q2. KMS는 어떤 암호화 알고리즘을 사용하나요?
A. 기본적으로 AES-256, RSA, ECC 등 다양한 알고리즘을 지원합니다.

### Q3. KMS와 CloudHSM의 차이는?
A. KMS는 소프트웨어 기반, CloudHSM은 하드웨어 기반 키 관리 서비스입니다. 보안 요구사항에 따라 선택.

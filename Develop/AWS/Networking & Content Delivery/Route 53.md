...
**실무 팁:**
TTL을 너무 짧게 설정하면 DNS 쿼리 비용이 증가한다. 자주 변경하지 않는 레코드는 3600초로 설정한다.
...
Route 53의 가장 강력한 기능 중 하나로, 다양한 조건에 따라 트래픽을 분배할 수 있다.
...
**실무 팁:**
CloudFront와 Route 53을 함께 사용하면 성능과 가용성을 모두 개선할 수 있다.

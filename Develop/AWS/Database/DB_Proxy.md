...
# myapp-proxy.proxy-xxxx.ap-northeast-2.rds.amazonaws.com
...
### Lambda — RDS Proxy 연결 (Node.js)

```javascript
const mysql = require('mysql2/promise');
const { Signer } = require('@aws-sdk/rds-signer');

// IAM 인증 토큰 생성 후 연결 (15분마다 갱신 필요)
async function getConnection() {
    ...
    return mysql.createConnection({
        ...
        database: 'myapp',
        ssl:      { rejectUnauthorized: true },  // TLS 필수
    });
}

// Lambda 핸들러 — 연결 재사용 (핸들러 밖에서 선언)
let connection;

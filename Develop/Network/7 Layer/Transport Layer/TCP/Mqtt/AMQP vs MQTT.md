---
title: AMQP vs MQTT 개념 비교
tags: [network, 7-layer, transport-layer, tcp, mqtt, amqp, messaging]
updated: 2025-01-27
---
# AMQP와 MQTT의 차이점
...
- 발신자와 수신자가 동시에 온라인에 있지 않아도 메시지를 주고받을 수 있게 해줌

**메시지 큐잉**
- 메시지를 일시적으로 저장했다가 적절한 시점에 전달하는 방식
- 비동기 통신을 가능하게 하여 시스템의 안정성과 확장성을 높임
...
- IoT 환경에서 센서 데이터를 수집하고 전송하는 데 최적화

...
tags: [aws, proxy, kubernetes, encryption]
updated: 2026-08-07
---
...
AWS가 2024년에 **App Mesh 신규 고객 받지 않고 기존 사용자도 새 기능 개발을 중단한다**는 취지의 공지를 냈다. AWS 는 종료일을 **2026년 9월 30일**로 공지했다. 그날 이후로는 콘솔과 리소스에 접근 자체가 안 된다. 이미 쓰고 있다면 마감이 정해진 이전 작업이고, 신규 도입 서비스에서는 완전히 손을 떼는 게 맞다. 기존 App Mesh 사용자라면 마이그레이션 계획을 세워야 한다.
